...
public class AudioBook extends AudioContent
{
  ...
  // Print information about the audiobook. First print the basic information of the AudioContent 
	...
	// see the video
	//Call super printInfo method and also print author and narrator
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	{
		//Loop through each chapter title and print it
	...
	//Check and return if the aforementioned information is equal
	public boolean equals(Object other)
	{
		AudioBook otherA= (AudioBook) other;
		return super.equals(other)&&this.author.equals(otherA.author)&&this.narrator.equals(otherA.narrator);
	}
